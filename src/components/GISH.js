    ...
    return (
        <section className="my-5">
            <div>
                ...
                <div>
                    <p>This site is for one of the tasks for the August 2022 Hunt, taking off from the satirical site <a href="https://birdsarentreal.com/" target="_blank" rel="noreferrer">Birds Aren't Real</a>. This "conspiracy" is entirely tongue-in-check.</p>
                </div>
            </div>
        </section>
    );
